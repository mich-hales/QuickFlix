...
const movieButton = document.getElementById("random-movie");
...
fetch(
  ...
  .then((data) => {
    ...
    // console.log("Movie array 1: " + movieArray);
    // return movieArray;
  });
// });
...
function chooseMovie() {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      var movieTitle = movieArray[x].title;
      var moviePoster = movieArray[x].poster_path;
    });
  ...
  //   .setAttribute("src", "https://image.tmdb.org/t/p/original/" + moviePoster);
